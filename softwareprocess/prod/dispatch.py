...
# ===========above is about assumedLong
        ...
        intermediateDistancenumber=round(math.sin(math.radians(latnumberrad)),3)*math.sin(math.radians(assumedLatnumber))+math.cos(math.radians(latnumberrad))*math.cos(math.radians(oassumedLongnumber))*math.cos(math.radians(LHAnumber))
